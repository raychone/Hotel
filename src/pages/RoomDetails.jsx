          ...
          <div className="w-full h-full lg:w-[60%] px-6">
            ...
            <div className="mt-12">
              ...
              <p className="mb-12">
                ...
                Laudantium quidem voluptate aliquid eius, praesentium ab placeat
                ratione? Animi, provident illum.
              </p>
            </div>
            <Facilities />
          </div>
          ...
          <div className="w-full h-full lg:w-[40%]">
            ...
            <div>
              ...
              <p className="mb-6">
                ...
                vero voluptatem non tempora qui! Autem magni non nesciunt earum.
                Repellat?
              </p>
